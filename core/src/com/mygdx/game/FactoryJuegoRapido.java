...
public class FactoryJuegoRapido implements FactoryJuego {
    @Override
    public Tarro crearTarro() {
        Texture bucketTexture = new Texture(Gdx.files.internal("bucket.png"));
        Sound hurtSound = Gdx.audio.newSound(Gdx.files.internal("hurt.ogg"));
        ComportamientoTarro comportamientoTarro = new ComportamientoTarroRapido();
    ...
    public Lluvia crearLluvia() {
        ...
        ComportamientoLluvia comportamientoLluvia = new ComportamientoLluviaRapida();
